...
# Shared Figures folder and bundled data at the repo root.
REPO_ROOT = Path(__file__).resolve().parents[2]
FIGURES = REPO_ROOT / "Figures"
DATA_DIR = REPO_ROOT / "data" / "carbonate_thickness"
...
def main():
    ...
    ap.add_argument("--table", default=str(DATA_DIR / "Table_carbonate_thickness.docx"))
    ap.add_argument("--grid-mean", default=str(DATA_DIR / "compacted_carbonate_thickness_present_mean.nc"))
    ap.add_argument("--grid-min", default=str(DATA_DIR / "compacted_carbonate_thickness_present_min.nc"))
    ap.add_argument("--grid-max", default=str(DATA_DIR / "compacted_carbonate_thickness_present_max.nc"))
    ap.add_argument("--outdir", default="output_ground_truth")
