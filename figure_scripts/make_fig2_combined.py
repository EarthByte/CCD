...
ax.text(MHT+3,262,"Haq (1987)",fontsize=8.5,ha="right",va="top",color="0.35")
ax.text(MHT-3,262,"Miller (2024)",fontsize=8.5,ha="left",va="top",color="0.35")
...
iax=ax.inset_axes([0.352,0.125,0.35,0.40],zorder=8); iax.set_facecolor("white"); iax.patch.set_alpha(1.0)
...
iax.text(0.96,0.06,f"CCD = {rma['intercept']:.0f} − {abs(rma['slope']):.2f}×SL\nr = {rma['r']:.2f},  R² = {rma['r2']:.2f}",
         transform=iax.transAxes,fontsize=9,va="bottom",ha="right",bbox=dict(boxstyle="round,pad=0.25",fc="white",ec="0.5",lw=0.5,alpha=0.8))
...
EVENTS=[(137.0,"WE"),(119.0,"ACIP"),(93.9,"OAE2"),(56.0,"PETM"),(33.9,"EOT"),(15.2,"Monterey")]
...
def plab(a,t,x=-0.085,y=1.02):
    a.text(x,y,t,transform=a.transAxes,fontsize=14,fontweight="bold",va="bottom",ha="right",
           bbox=dict(boxstyle="square,pad=0.32",fc="white",ec="black",lw=1.1))
plab(ax,"a")
